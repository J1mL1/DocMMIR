...
if __name__ == "__main__":
    input_file = "/map-vepfs/siwei/ziruili/DocMMIR/data/arxiv_json/3_generated_query.json"
    output_file = "/map-vepfs/siwei/ziruili/DocMMIR/data/arxiv_json/3_generated_query_split.json"
